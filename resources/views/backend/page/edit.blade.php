    ...
    <div class="card-body text-center">    
        <form>
            <div class="form-group d-flex">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control placeholder" id="title" name="title" placeholder="Enter title here">
                </div>
            </div>
            <div class="form-group d-flex">
            ...
            <div class="form-group d-flex">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control placeholder" id="summernote" name="description" rows="5" placeholder="Enter description  here"></textarea>
                </div>
            </div>
